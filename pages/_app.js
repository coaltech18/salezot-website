...
export default function App({ Component, pageProps }) {
  return (
    <>
      <Head>
        <title>Salezot — AI-Powered Revenue Intelligence for Indian B2B Sales Teams</title>
        <meta
          name="description"
          content="Salezot records, transcribes, and analyses every sales call with AI — giving reps real-time coaching and managers full pipeline visibility. Built for India."
        />
        <meta charSet="utf-8" />
